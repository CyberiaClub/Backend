...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`BOLETA` (
  ...
  INDEX `fk_BOLETA_COMPROBANTE_DE_PAGO1_idx` (`ID_COMPROBANTE_DE_PAGO` ASC) VISIBLE,
  CONSTRAINT `fk_BOLETA_COMPROBANTE_DE_PAGO1`
...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`FACTURA` (
  ...
  INDEX `fk_FACTURA_COMPROBANTE_DE_PAGO1_idx` (`ID_COMPROBANTE_DE_PAGO` ASC) VISIBLE,
  CONSTRAINT `fk_FACTURA_COMPROBANTE_DE_PAGO1`
    FOREIGN KEY (`ID_COMPROBANTE_DE_PAGO`)
    REFERENCES `CyberiaStore`.`COMPROBANTE_DE_PAGO` (`ID_COMPROBANTE_DE_PAGO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`BOLETA_X_CLIENTE` (
  ...
  INDEX `fk_BOLETA_X_CLIENTE_CLIENTE1_idx` (`ID_CLIENTE` ASC) VISIBLE,
  CONSTRAINT `fk_BOLETA_X_CLIENTE_CLIENTE1`
    FOREIGN KEY (`ID_CLIENTE`)
    REFERENCES `CyberiaStore`.`CLIENTE` (`ID_CLIENTE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_BOLETA_X_CLIENTE_BOLETA1`
