...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`PRODUCTO_COMPUESTO` (
  ...
  INDEX `fk_PRODUCTO_has_PRODUCTO_PRODUCTO1_idx` (`ID_PRODUCTO` ASC) VISIBLE,
  INDEX `fk_PRODUCTO_has_PRODUCTO_PRODUCTO_idx` (`ID_PRODUCTO_PADRE` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`PRODUCTO_X_PROVEEDOR` (
  ...
  PRIMARY KEY (`ID_PRODUCTO`),
  INDEX `fk_PROVEEDOR_has_PRODUCTO_PRODUCTO1_idx` (`ID_PRODUCTO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`PRODUCTO_X_MARCA` (
  ...
  INDEX `fk_PRODUCTO_has_MARCA_PRODUCTO1_idx` (`ID_PRODUCTO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`PRODUCTO_X_OFERTA` (
  ...
  INDEX `fk_PRODUCTO_has_OFERTA_PRODUCTO1_idx` (`ID_PRODUCTO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`BOLETA_X_CLIENTE` (
  ...
  INDEX `fk_BOLETA_has_CLIENTE_BOLETA1_idx` (`ID_BOLETA` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`ROL_X_USUARIO` (
  ...
  INDEX `fk_USUARIO_has_ROL_USUARIO1_idx` (`ID_USUARIO` ASC) VISIBLE,
