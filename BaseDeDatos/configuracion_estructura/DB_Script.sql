...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`COMPROBANTE_DE_PAGO` (
  ...
  INDEX `fk_COMPROBANTE_DE_PAGO_TIPO_TRANSACCION1_idx` (`ID_TIPO_TRANSACCION` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_COMPROBANTE_DE_PAGO_TIPO_TRANSACCION1`
    ...
    REFERENCES `CyberiaStore`.`TIPO_DE_COMPROBANTE` (`ID_TIPO_TRANSACCION`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `CyberiaStore`.`COMPROBANTE_DE_PAGO_X_PRODUCTO` (
  ...
  INDEX `fk_COMPROBANTE_DE_PAGO_has_PRODUCTO_COMPROBANTE_DE_PAGO1_idx` (`ID_COMPROBANTE_DE_PAGO` ASC) VISIBLE,
